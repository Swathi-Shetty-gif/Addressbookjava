...
public class AddressBook {
	...
	File f1=new File("C:/Users/Vishwas/eclipse-workspace/employee/src/com/bridgelabz/addressbook.txt"+firstname+".txt");
	f1.createNewFile();
	...
	bw.close();
			...
			File f2=new File("C:/Users/Vishwas/eclipse-workspace/employee/src/com/bridgelabz/addressbook.txt"+search+".txt");
			...
			if (choice==3) {
				...
				String del=sc.next();
				File f4=new File("C:/Users/Vishwas/eclipse-workspace/employee/src/com/bridgelabz/addressbook.txt"+del+".txt");
			...
			if (choice == 4) {
				...
				String edit=sc.next();
				File f3=new File("C:/Users/Vishwas/eclipse-workspace/employee/src/com/bridgelabz/addressbook.txt"+edit+".txt");
				boolean e=f3.exists();
				if (e==true) {
					...
					FileWriter fw1=new FileWriter("C:/Users/Vishwas/eclipse-workspace/employee/src/com/bridgelabz/addressbook.txt"+firstname+".txt");
